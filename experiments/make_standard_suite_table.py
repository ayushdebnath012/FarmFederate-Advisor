...
def main() -> None:
    ...
    L = [BS + "begin{table*}[t]",
         BS + "caption{Federated results on 371 genuine box-linked crop--note "
         "observations (260/53/58 over 153 independent source groups; no "
         "synthetic images). Every architecture within a cell trains on the "
