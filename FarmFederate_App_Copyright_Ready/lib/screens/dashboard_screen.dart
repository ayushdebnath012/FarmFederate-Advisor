    ...
    return Scaffold(
      ...
      body: IndexedStack(
        ...
        children: [
          ...
          AdvisoryChatScreen(apiBase: widget.apiBase),
      ...
      child: SafeArea(
        child: Column(
          children: [
            ...
            _drawerItem(Icons.support_agent, 'Farm Advisor', () {
              Navigator.pop(context);
            ...
            _drawerItem(Icons.tune, 'Profile Settings', () {
              Navigator.pop(context);
              Navigator.pushNamed(context, '/profiles');
            }),
            _drawerItem(Icons.emoji_events, 'Performance Results', () {
              Navigator.pop(context);
              Navigator.pushNamed(context, '/performance');
            }),
            _drawerItem(Icons.group, 'Farm Network', () {
              Navigator.pop(context);
              Navigator.pushNamed(context, '/farm-network');
            }),
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 20),
              child: Divider(color: Colors.white12),
          ...
          Row(
            children: [
              Expanded(
                child: _sensorTile(
                  'Temp',
                  '${d.airTemperature.toStringAsFixed(1)} deg',
                  Icons.thermostat,
  ...
  Widget _buildFeatureHighlights() {
    return Column(
      ...
      children: [
        ...
        _featureCard(
          '203 Profile Configurations',
          '5 Text x 5 Image x 8 fusion + 3 network strategies',
          Icons.tune,
          AppTheme.accentBlue,
          () => Navigator.pushNamed(context, '/performance'),
        ),
        ...
        _featureCard(
          'Privacy-Preserving',
          'Networked learning keeps your data on-device',
          Icons.security,
          AppTheme.accentCyan,
          () => Navigator.pushNamed(context, '/farm-network'),
        ),
