    ...
    try {
      ...
      setState(() {
        ...
        _allScores = (res['all_scores'] as List?)
                ...
                .toList() ??
            [];
        _modelLabel = res['model'] as String?;
    ...
    try {
      ...
      setState(() {
        ...
        _allScores = (res['all_scores'] as List?)
                ...
                .toList() ??
            [];
        _modelLabel = res['matched_by'] == 'description'
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton.icon(
            ...
            label:
                Text(_loading ? 'Loading...' : 'Identify Disease & Show Image'),
            style: ElevatedButton.styleFrom(
              backgroundColor: AppTheme.primaryGreen,
              foregroundColor: Colors.white,
              padding: const EdgeInsets.symmetric(vertical: 14),
  ...
  Widget _buildResultImage() {
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
            color: _classColor(_className).withValues(alpha: 0.5), width: 2),
      ),
      child: ClipRRect(
        borderRadius: BorderRadius.circular(14),
            ...
            child: Column(
              ...
              children: [
                ...
                if (_confidence != null) ...[
                  ...
                  const Text('Reference image from dataset',
            ...
            return Padding(
              ...
              child: Row(
                children: [
                  SizedBox(
                    width: 130,
                    child: Text(s['display'] as String? ?? cls,
                        style: const TextStyle(
